...
export class AgentPromptOptimizer implements FixExecutor {
  ...
  readonly supportedSources = ['agent'] as const
   ...
   */
  private async executeAutoPatch(problem: AssignedProblem, plan: Record<string, any>, startTime: number): Promise<FixResult> {
