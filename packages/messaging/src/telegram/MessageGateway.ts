...
import type { DataSourceToolDef, DataSourceResult, OutputFormat } from '@akemi-mio/messaging/telegram/DataSourceTool'
import { dataSourceResultToMCP, formatForTelegram, isFormatSupported } from '@akemi-mio/messaging/telegram/DataSourceTool'
...
export class MessageGateway {
   ...
   * 自动转换附件为 MCP 内容格式。
   */
  async executeToolAsMCP(name: string, args: Record<string, any> = {}, format: OutputFormat = 'auto'): Promise<MCPToolResult> {
