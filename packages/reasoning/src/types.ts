...
export interface Goal {
  type: 'identify_root_cause' | 'compare_options' | 'evaluate_tradeoffs' | 'explain_causality' | 'provide_recommendation'
  /** 目标的补充描述 */
  description?: string
}
...
export interface Constraint {
  type: 'scope' | 'assumption' | 'priority'
  description: string
}
...
/**
 * 鎺ㄧ悊瑙勫垝鍣ㄨ緭鍏ヤ笂涓嬫枃 鈥?鐢ㄦ埛杈撳叆 + 瀵硅瘽蹇収銆?
 */
export interface ReasoningContext {
  input: {
    /** 鐢ㄦ埛杈撳叆鐨勬枃鏈?*/
    text: string
    /** 杈撳叆鍐呭鍒嗙被锛堝 'blog', 'code', 'question'锛?*/
    category?: string
    /** 鍦烘櫙鏍囪瘑锛堝 'deep_discussion', 'analysis', 'decision'锛?*/
    scene?: string
    /** 闄勫姞鍏冩暟鎹?*/
...
/** 鎺ㄧ悊瑙勫垝鍣ㄨ緭鍏ワ紙鍙嶅悜鍏煎鎬у埆鍚嶏級 */
export type PlannerInput = ReasoningContext
