...
export type LearningCategory =
  '基础类型' | '泛型' | '条件类型' | '映射类型' | '模板字面量类型' | '工具类型' | '类型守卫' | '类型推断' | '声明文件' | '模块' | '其他'
...
export const TYPESCRIPT_LEARNING_ITEMS: Array<{
  ...
  { name: 'Template Literal Types', category: '模板字面量类型', difficulty: 'medium', tags: ['template', '`${}`', 'literal'] },
  {
    ...
    category: '模板字面量类型',
    difficulty: 'hard',
    tags: ['Uppercase', 'Lowercase', 'Capitalize', 'Uncapitalize'],
  },
  {
    name: 'Pattern Matching with Template',
    category: '模板字面量类型',
    difficulty: 'hard',
    tags: ['infer', 'pattern', 'template', 'match'],
  },
