...
import type { StartupSignal, SignalUrgency } from '@akemi-mio/intelligence-startup-radar/types'
...
export class TtsRadarAdapter {
   ...
   */
  cleanSignal(signal: Pick<StartupSignal, 'title' | 'summary'>, options?: SignalCleanOptions): { title: string; summary: string } {
    return {
   ...
   * @returns 清理后的信号字段
   */
  prepareForTelegram(signal: Pick<StartupSignal, 'title' | 'summary'>, options?: SignalCleanOptions): { title: string; summary: string } {
