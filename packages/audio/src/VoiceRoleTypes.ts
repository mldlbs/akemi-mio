...
/** 角色 ID → 角色 查找表 */
export const VOICE_ROLE_MAP: Record<string, VoiceRole> = Object.fromEntries(BUILTIN_VOICE_ROLES.map((r) => [r.id, r]))
...
/** 所有内置方案列表 */
export const BUILTIN_VOICE_SCHEMES: VoiceRoleScheme[] = [DEFAULT_VOICE_SCHEME, GEEK_VOICE_SCHEME, GENTLE_VOICE_SCHEME]
