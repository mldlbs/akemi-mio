...
export interface PluginAPI {
  ...
  http: {
    get(url: string, options?: Record<string, any>): Promise<{ status: number; data: any }>
    post(url: string, body: any, options?: Record<string, any>): Promise<{ status: number; data: any }>
  }
}
