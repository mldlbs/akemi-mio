...
export function createDefaultMerge<TResult extends object>(overrides?: Partial<MergeStrategy<TResult>>): MergeStrategy<TResult> {
 ...
 */
export class MapHookChain<TCtx, TResult extends object> {
