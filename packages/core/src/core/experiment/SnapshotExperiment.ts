...
export class SnapshotManager<TBaseline = unknown> {
   ...
   * @returns 创建的快照
   */
  createSnapshot(currentData: TBaseline, changes?: string[], tags?: string[]): Snapshot<TBaseline> {
   ...
   * @returns 评估结果
   */
  evaluateAndDecide(snapshotId?: string, currentData?: TBaseline): EvaluationResult<TBaseline> {
