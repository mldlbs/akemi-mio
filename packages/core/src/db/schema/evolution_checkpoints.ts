...
export type EvolutionCheckpointPhase = 'pre_cycle' | 'pre_pipeline' | 'in_collect' | 'pre_execute' | 'post_execute' | 'pre_commit'

export type EvolutionCheckpointStatus = 'pending' | 'in_progress' | 'completed' | 'failed' | 'rolled_back' | 'interrupted'
