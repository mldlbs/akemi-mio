...
import { acousticEnvClassifier, type AcousticEnvironment, ENV_LABELS } from '@akemi-mio/audio/AsrAcousticEnvironmentClassifier'
...
export class AsrAcousticOptimizationExecutor implements FixExecutor {
   ...
   * 从识别记录中统计各环境类型的出现次数。
   */
  private analyzeEnvironmentDistribution(records: Array<{ environment?: string }>): Map<AcousticEnvironment, number> {
