    ...
    const presets: Array<{ label: string; overrides: Partial<Record<string, number | string>> }> = [
      {
        label: 'default',
        overrides: {
          platform_priority: 'generic',
          publish_hour: 20,
          publish_day: 3,
          content_style: 'mixed',
          content_length_target: 2000,
      ...
      },
      {
        label: 'csdn_focus',
        overrides: {
          platform_priority: 'csdn',
          publish_hour: 9,
          publish_day: 2,
          content_style: 'tutorial',
          content_length_target: 3000,
      ...
      },
      {
        label: 'zhihu_focus',
        overrides: {
          platform_priority: 'zhihu',
          publish_hour: 20,
          publish_day: 4,
          content_style: 'opinion',
          content_length_target: 2500,
      ...
      },
      {
        label: 'juejin_focus',
        overrides: {
          platform_priority: 'juejin',
          publish_hour: 10,
          publish_day: 3,
          content_style: 'tutorial',
          content_length_target: 2000,
          engagement_focus: 0.6,
        },
      },
      {
        label: 'wechat_focus',
        overrides: {
          platform_priority: 'wechat',
          publish_hour: 21,
          publish_day: 1,
          content_style: 'story',
