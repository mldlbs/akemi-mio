...
import type { MCPRegistry } from '@akemi-mio/intelligence-mcp/MCPRegistry'
import { type CapabilityDefinition, type CapabilityProvider, type ResolveResult } from './types'
