...
import { getObserverService } from '@akemi-mio/capabilities/tool/deps'
  ...
  inputJSONSchema: {
    ...
    properties: {
      sources: {
        type: 'array',
        items: { type: 'string' },
        description: '采集源名称列表。可选值: hackernews, weibo-hot, github-trending, bilibili, douyin, rss。传入 ["all"] 采集所有源',
      },
      keywords: {
        type: 'array',
        items: { type: 'string' },
