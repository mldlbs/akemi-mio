...
import { type DegradationRule, type DegradationConfig, DEFAULT_DEGRADATION_CONFIG, findMatchingRules } from './ToolDegradationConfig'
...
export class ToolFallbackRegistry {
   ...
   * 按条件精度排序，仅返回已启用的规则。
   */
  getFallbacks(primaryTool: string, errorType?: ToolErrorType, errorMessage?: string): DegradationRule[] {
    this.ensureDefaults()
