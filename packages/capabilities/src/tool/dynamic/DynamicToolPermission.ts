...
export class DynamicToolPermission {
   ...
   * @returns 检查结果
   */
  checkRegistration(config: ToolPermissionConfig, sessionId: string): PermissionCheckResult {
   ...
   * @returns 检查结果
   */
  checkHandlerApis(handlerBody: string, config: ToolPermissionConfig): PermissionCheckResult {
