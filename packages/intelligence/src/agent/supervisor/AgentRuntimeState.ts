...
export const RUNTIME_TRANSITIONS: Record<AgentRuntimeState, AgentRuntimeState[]> = {
  [AgentRuntimeState.READY]: [AgentRuntimeState.RUNNING, AgentRuntimeState.CANCELLED],
  ...
  [AgentRuntimeState.PAUSED]: [AgentRuntimeState.RUNNING, AgentRuntimeState.CANCELLED, AgentRuntimeState.INTERRUPTED],
  [AgentRuntimeState.INTERRUPTED]: [AgentRuntimeState.RUNNING, AgentRuntimeState.CANCELLED],
  [AgentRuntimeState.COMPLETED]: [AgentRuntimeState.READY],
  [AgentRuntimeState.FAILED]: [AgentRuntimeState.READY],
  [AgentRuntimeState.CANCELLED]: [AgentRuntimeState.READY],
}

/** 安全转移 */
export function transitionRuntimeState(from: AgentRuntimeState, to: AgentRuntimeState): boolean {
