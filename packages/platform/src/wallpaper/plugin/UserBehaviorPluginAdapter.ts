...
import type { IWallpaperPlugin, WallpaperPluginManifest, IBehaviorProvider, WallpaperBehaviorSnapshot } from '@akemi-mio/platform/wallpaper/plugin/types'
...
export class UserBehaviorPluginAdapter implements IWallpaperPlugin {
  ...
  async onLoad(): Promise<void> {
    ...
    this.unsubEvent = eventBus.on('behavior.state.updated' as any, () => {
