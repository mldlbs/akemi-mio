...
export { EvolutionDashboardService, type EvolutionDashboardState } from '@akemi-mio/platform/wallpaper/EvolutionDashboardService'
...
export {
  ...
  type MemoryContextDisplayType,
} from '@akemi-mio/platform/wallpaper/MemoryContextService'
...
} from '@akemi-mio/platform/wallpaper/ConversationContextService'
...
export {
  ...
  type OrganizerProgressPayload,
  type FileMoveEvent,
  type FileMoveResult,
  type FileMoveStatus,
  type SessionStatus,
} from '@akemi-mio/platform/wallpaper/FileOrganizerProgressService'

// =============================================================================
// Re-export wallpaper plugin system
// =============================================================================

export { WallpaperPluginRegistry, UserBehaviorPluginAdapter } from '@akemi-mio/platform/wallpaper/plugin'
export type {
  IWallpaperPlugin,
  IBehaviorProvider,
...
} from '@akemi-mio/platform/wallpaper/plugin'
