import { McpClient } from '@akemi-mio/intelligence-mcp/McpClient'
import type { MCPServerConfig } from '@akemi-mio/intelligence-mcp/types'
...
export class UumitService {
  ...
  private async connect(): Promise<void> {
    ...
    try {
      ...
      log('WARN', 'uumit_connect_giving_up', { error: err.message, reason: 'auto-reconnect disabled' })
