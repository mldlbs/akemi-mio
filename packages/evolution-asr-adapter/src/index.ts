...
// ── 输入类型（供消费者使用） ──
export type { AsrVoiceEmotionInput, AsrEnvironmentInput, AsrConfidenceInput, AsrDomainStatInput } from './AsrBehaviorTypes'

// ── 输出类型（供消费者使用） ──
export type { BehaviorContextHint, AsrQualitySignal, AsrBehaviorOutput } from './AsrBehaviorTypes'
