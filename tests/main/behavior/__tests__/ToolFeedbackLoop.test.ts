...
const mocks = vi.hoisted(() => ({
  mockOn: vi.fn(),
  mockEmit: vi.fn(),
  mockRecordToolCallResult: vi.fn(),
  mockSuppressTool: vi.fn(),
  mockUnsuppressTool: vi.fn(),
  mockConfirmTool: vi.fn(),
  mockUnconfirmTool: vi.fn(),
  mockGetSuppressedTools: vi.fn(() => []),
  mockGetConfirmedTools: vi.fn(() => []),
}))
...
vi.mock('@akemi-mio/intelligence/agent/UserBehaviorAnalyzer', () => ({
  userBehaviorAnalyzer: {
    recordToolCallResult: mocks.mockRecordToolCallResult,
    suppressTool: mocks.mockSuppressTool,
    unsuppressTool: mocks.mockUnsuppressTool,
    confirmTool: mocks.mockConfirmTool,
    unconfirmTool: mocks.mockUnconfirmTool,
    getSuppressedTools: mocks.mockGetSuppressedTools,
    getConfirmedTools: mocks.mockGetConfirmedTools,
  },
}))
...
const {
  mockOn,
  mockEmit,
  mockRecordToolCallResult,
  mockSuppressTool,
  mockUnsuppressTool,
  mockConfirmTool,
  mockUnconfirmTool,
  mockGetSuppressedTools,
  mockGetConfirmedTools,
} = mocks

import { ToolFeedbackLoop, toolFeedbackLoop } from '@akemi-mio/evolution/behavior/ToolFeedbackLoop'
