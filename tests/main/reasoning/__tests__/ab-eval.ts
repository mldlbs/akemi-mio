...
import { translate as translateOld } from '@akemi-mio/intelligence/llm/PromptBuilder'

// Capture the file at a known state — we need the NEW version too
import type { ReasoningDirective, ThinkingPattern, OutputStyle, ReasoningContext } from '@akemi-mio/reasoning/types'
