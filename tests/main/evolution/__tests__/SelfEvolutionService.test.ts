...
vi.mock('@akemi-mio/core/core/Lifecycle', () => ({
  getMainWindow: vi.fn(() => null),
}))

import { SelfEvolutionService } from '@akemi-mio/evolution/SelfEvolutionService'
import type { DevPlan, PlanStep } from '@akemi-mio/evolution/types'
