...
import { Scratchpad, AttentionSet, WorkingMemory } from '@akemi-mio/intelligence/agent/WorkingMemory'
...
describe('WorkingMemory', () => {
  ...
  it('injectScratchpad 将 scratchpad 注入消息数组', () => {
    wm.addUser('问题')
    const external: Message[] = [{ role: 'system', content: 'sys' }]
