...
import { rebuildExecutionSteps } from '@akemi-mio/capabilities/workflow/WorkflowScheduler'
import type { WorkflowStepRun } from '@akemi-mio/capabilities/workflow/types'
...
describe('rebuildExecutionSteps — resume context contract', () => {
  ...
  it('should handle mixed states correctly', () => {
    const steps = [done('s1', 'a'), failed('s2'), skipped('s3'), pending('s4'), done('s5', 'b')]
