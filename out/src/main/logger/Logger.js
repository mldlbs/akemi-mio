import { createWriteStream, existsSync, mkdirSync, readdirSync, renameSync, unlinkSync, statSync } from 'fs';
...
const ERROR_REPORT_INTERVAL = 60000; // 相同 event 至少间隔 1 分钟
function reportError(entry) {
    ...
    try {
        ...
        const req = https.request(FEEDBACK_API, {
            method: 'POST',
...
export function initLogFile(userDataPath) {
