...
export const LLM_VISION_API_URL = process.env.LLM_VISION_API_URL || process.env.LLM_API_URL || 'https://opencode.ai/zen/go/v1/chat/completions';
...
export const EVOLUTION_SAFETY_MODE = process.env.EVOLUTION_SAFETY_MODE === 'auto' ? 'auto' : 'review';
