 ...
 */
export function verifyPlugin(filePath, pluginName) {
 ...
 */
function verifyEd25519(filePath) {
    let content;
    try {
    ...
    try {
        ...
        return verify(null, Buffer.from(contentToVerify, 'utf-8'), publicKey, signature);
    }
    catch {
        return false;
    }
