export declare const plans: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    ...
    columns: {
        ...
        reflection: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            name: "reflection";
            tableName: "plans";
            dataType: "string";
            columnType: "SQLiteText";
...
export declare const planSteps: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: "plan_steps";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/sqlite-core").SQLiteColumn<{
        ...
        status: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            ...
            dataType: "string";
            columnType: "SQLiteText";
            data: "pending" | "in_progress" | "done" | "failed";
            driverParam: string;
            notNull: true;
            hasDefault: true;
            isPrimaryKey: false;
            isAutoincrement: false;
            hasRuntimeDefault: false;
            enumValues: ["pending", "in_progress", "done", "failed"];
            baseColumn: never;
            identity: undefined;
            generated: undefined;
        }, {}, {
