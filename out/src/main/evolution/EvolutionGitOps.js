...
export var RollbackLevel;
(function (RollbackLevel) {
    RollbackLevel["TASK"] = "task";
    RollbackLevel["MODULE"] = "module";
    RollbackLevel["SYSTEM"] = "system";
...
export class EvolutionGitOps {
    ...
    async workspacePreCheck(lastSuccessTime) {
        try {
            ...
            if (lastSuccessTime > 0 && lastSuccessTime > oneHourAgo)
                return false;
    ...
    async rollbackToSnapshot(branch, level = RollbackLevel.MODULE) {
        try {
