...
export function SettingsAppearanceTab() {
  ...
  useEffect(() => {
    ...
    // 加载实时仪表盘配置
    window.electronAPI
      .getEvolutionDashboardLiveConfig()
      .then((cfg) => {
        ...
        <>
              ...
              {wp.adaptiveOpacity && (
                <>
                  <div className="wallpaper-settings-slider-row">
                    ...
                    />
                    <span className="wallpaper-settings-slider-value">{Math.round(wp.codeOpacity * 100)}%</span>
                  </div>
                  ...
                  <div className="wallpaper-settings-slider-row">
                    ...
                    />
                    <span className="wallpaper-settings-slider-value">{Math.round(wp.fullscreenOpacity * 100)}%</span>
                  </div>
                  ...
                  <div className="wallpaper-settings-slider-row">
                    ...
                    />
                    <span className="wallpaper-settings-slider-value">{Math.round(wp.idleOpacity * 100)}%</span>
                  </div>
                  ...
                  <div className="wallpaper-settings-slider-row">
                    ...
                    />
                    <span className="wallpaper-settings-slider-value">{Math.round(wp.normalOpacity * 100)}%</span>
                  </div>
                </>
              )}
          ...
          {evoDashboardEnabled && (
            <div className="wallpaper-settings-section">
              <div className="wallpaper-settings-slider-row">
                ...
                />
                <span className="wallpaper-settings-slider-value">{Math.round(evoDashboardOpacity * 100)}%</span>
              </div>
          ...
          {focusConfig.enabled && (
            <>
              ...
              {/* ── 专注提醒 ── */}
              <span className="settings-section-title">专注提醒</span>
              ...
              <div className="wallpaper-settings-section">
                ...
                <div className="wallpaper-settings-slider-row">
                  ...
                  />
                  <span className="wallpaper-settings-slider-value">{focusConfig.restReminderAfterMs / 60_000}分钟</span>
                </div>
              </div>
            </>
          )}
