...
export function EmotionalWaveform() {
  ...
  const containerOpacity = waveformState === 'hidden' ? 0 : waveformState === 'entering' ? 0.8 : waveformState === 'exiting' ? 0 : 1
  ...
  return (
    ...
    >
      ...
      <div className="wp-emotional-waveform-footer">
        ...
        {segmentLabel && (
          <span className="wp-emotional-waveform-label" style={{ color: currentColor.primary }}>
            {segmentLabel}
          </span>
        )}
      </div>
