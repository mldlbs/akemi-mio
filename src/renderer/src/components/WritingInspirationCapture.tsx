  ...
  return (
    <>
      <div className={`writing-inspiration-btn${state === 'recording' ? ' recording' : ''}${isBusy ? ' busy' : ''}`}>
        ...
        {state === 'error' && <span className="inspiration-error-tip">{errorMsg}</span>}
      </div>
        ...
        <div className="inspiration-panel-overlay" onClick={dismissPanel}>
          <div className="inspiration-panel" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="inspiration-section">
                  ...
                  <div className="inspiration-tags">
                    {result.entities.characters.map((c, i) => (
                      <span key={i} className="inspiration-tag tag-character">
                        {c}
                      </span>
                    ))}
                  </div>
                ...
                <div className="inspiration-section">
                  ...
                  <div className="inspiration-tags">
                    {result.entities.events.map((e, i) => (
                      <span key={i} className="inspiration-tag tag-event">
                        {e}
                      </span>
                    ))}
                  </div>
                ...
                <div className="inspiration-section">
                  ...
                  <div className="inspiration-tags">
                    {result.entities.emotions.map((em, i) => (
                      <span key={i} className="inspiration-tag tag-emotion">
                        {em}
                      </span>
                    ))}
                  </div>
                ...
                <div className="inspiration-section">
                  ...
                  <div className="inspiration-tags">
                    {result.entities.plotTurns.map((pt, i) => (
                      <span key={i} className="inspiration-tag tag-plot-turn">
                        {pt}
                      </span>
                    ))}
                  </div>
            ...
            <div className="inspiration-panel-footer">
              <span className="inspiration-meta">处理耗时: {(result.processingMs / 1000).toFixed(1)}s</span>
