...
export function VoiceContinuationCapture({
  storyName,
  chapterNum,
  onSendContinuation,
  onClose,
  disabled,
}: VoiceContinuationCaptureProps) {
  ...
  const proceedToGenerate = useCallback(async (text: string, atmo: AudioAtmosphere | null) => {
    setState('generating')
    try {
        ...
        <div className="inspiration-panel-body">
          ...
          <div className="continuation-context-info">
            ...
            {initData && (
              <span className="continuation-context-meta">
                已存在 {initData.totalChapters} 章
                {initData.previousChapter && ` · 前章: ${initData.previousChapter.title}`}
              </span>
            )}
          </div>
          ...
          {state === 'ready' && (
            <div className="continuation-ready">
              ...
              <p className="continuation-ready-text">
                请说出你对第{chapterNum}章的剧情期望或情感诉求
              </p>
              ...
              <div className="continuation-ready-actions">
                <button
                  className="inspiration-btn-primary"
                ...
                <button
                  className="inspiration-btn-secondary"
            ...
            <div className="continuation-status">
              ...
              {atmosphere && atmosphere.confidence > 0.2 && (
                <div className="continuation-atmosphere-preview" style={{ marginTop: 8 }}>
                  ...
                  <div className="continuation-atmo-badge" style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: 6,
                    padding: '4px 10px',
              ...
              {analysisError && (
                <div style={{ color: '#e74c3c', fontSize: 12, marginTop: 4 }}>{analysisError}</div>
              )}
            </div>
          )}
                    ...
                    <div className="inspiration-section">
                      ...
                      <div className="atmosphere-bars" style={{ marginTop: 8 }}>
                        {(['tension', 'joy', 'sadness', 'calmness', 'mystery', 'romance'] as const).map((key) => {
                          ...
                          return (
                            <div key={key} className="atmosphere-bar-row" style={{
                              display: 'flex',
                              alignItems: 'center',
                              gap: 8,
                              marginBottom: 4,
                              ...
                              <span style={{ width: 40, fontSize: 12, color: '#888' }}>
                                {ATMOSPHERE_LABELS[key]}
                              </span>
                              <div className="atmosphere-bar-track" style={{
                                flex: 1,
                                height: 8,
                                background: '#333',
                                borderRadius: 4,
                                ...
                                <div className="atmosphere-bar-fill" style={{
                              ...
                              <span style={{ width: 32, fontSize: 11, color: '#aaa', textAlign: 'right' }}>
