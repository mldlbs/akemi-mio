  ...
  return (
    <div className="tool-param-combo-item">
      ...
      <div className="tool-param-combo-args">
        ...
        {displayArgs.length > 4 && (
          <span className="tool-param-combo-more">+{displayArgs.length - 4}</span>
        )}
      </div>

      {/* 评分与元数据 */}
      <div className="tool-param-combo-meta">
        <span className={`tool-param-combo-rating ${combo.successRate >= 0.8 ? 'rating-high' : combo.successRate >= 0.5 ? 'rating-mid' : 'rating-low'}`}>
      ...
      {!feedbackGiven && (
        <div className="tool-param-combo-actions">
          <button
            className="tool-param-combo-btn tool-param-combo-adopt"
            onClick={handleAdopt}
            title="采纳此参数组合"
          >
          ...
          <button
            className="tool-param-combo-btn tool-param-combo-adjust"
          ...
          <button
            className="tool-param-combo-btn tool-param-combo-dismiss"
 ...
 */
export function ToolParamSuggestions({
  toolName,
  enabled = true,
  maxSuggestions = 3,
  onAdopt,
  onAdjust,
}: ToolParamSuggestionsProps) {
