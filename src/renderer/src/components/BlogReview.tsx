...
export function BlogReview({ content, title, onComplete, onBackToEdit }: BlogReviewProps) {
  ...
  const handleParaClick = useCallback(
    (index: number) => {
      ...
      setSelectedPara((prev) => (prev?.index === index ? null : { index, snippet }))
    },
    [content],
  )
  ...
  return (
    <div className="blog-review">
      ...
      <div className="blog-review-body">
        {editingEnabled ? (
          <textarea className="blog-review-textarea" value={editText} onChange={handleEditChange} spellCheck={false} />
        ) : (
            ...
            <div className="br-annotation-recorder">
              ...
              {recording || transcribing ? (
                <div className="br-annotation-status">
                  ...
                  <span className="br-annotation-rec-timer">{transcribing ? '识别中…' : formatDuration(recordDuration)}</span>
                  {recording && (
                ...
                .map((annot) => (
                  <div key={annot.id} className="br-annotation-item">
                    <div className="br-annotation-item-header">
                      <span className="br-annotation-para-badge">P{annot.paragraphIndex + 1}</span>
