...
import { DEFAULT_EMOTION_COLORS, DEFAULT_VOICE_WALLPAPER_CONFIG } from './types'
import type { VoiceVisualizationState, VoiceWallpaperConfig, EmotionColorScheme } from './types'
