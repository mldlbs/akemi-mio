    ...
    <div className="wp-wf-panel">
      ...
      >
        ...
        <div className="wp-wf-header-right">
          {isRunning && (
            <span className="wp-wf-percent">{progress.percent}%</span>
          )}
          ...
          <div className="wp-wf-summary">
            {stalled ? (
              ...
              <div className="wp-wf-stats">
                <span className="wp-wf-stat">{doneSteps}/{stepList.length} 步</span>
                {failedSteps > 0 && (
                  <span className="wp-wf-stat wp-wf-stat-fail">失败 {failedSteps}</span>
                )}
              </div>
            )}
          </div>
          ...
          <div className="wp-wf-run-detail wp-wf-run-active">
            <div className="wp-wf-run-header">
              <div className="wp-wf-run-title-group">
                ...
                <span className="wp-wf-run-badge wp-wf-run-badge-running">
                  {isCompleted ? '已完成' : isRunning ? '运行中' : '等待'}
                </span>
              </div>
