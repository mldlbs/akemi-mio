...
/** 内置场景 ID */
export type SceneId = 'forest' | 'castle' | 'beach' | 'stars' | 'cave' | 'lake' | 'rain' | 'snow' | 'sunset' | 'tavern'
...
/** 叠加效果类型 */
export type EffectType = 'rain' | 'snow' | 'fireflies' | 'torchlight' | 'sparkle' | 'stars_twinkle' | 'leaves_falling' | 'bubbles'
...
export const DEFAULT_SCENE_VISUALS: Record<SceneId, SceneVisualDefinition> = {
  forest: {
    ...
    elements: [
      ...
      { type: 'tree', x: 0.35, y: 0.6, scale: 1.0 },
      { type: 'tree', x: 0.55, y: 0.5, scale: 1.4 },
      { type: 'tree', x: 0.75, y: 0.58, scale: 1.1 },
      { type: 'tree', x: 0.9, y: 0.52, scale: 1.3 },
      { type: 'mountain', x: 0.5, y: 0.7, scale: 0.6 },
      { type: 'water', x: 0.5, y: 0.9, scale: 1.0 },
    ],
  ...
  castle: {
    ...
    elements: [
      { type: 'castle', x: 0.5, y: 0.55, scale: 1.0 },
      { type: 'torch', x: 0.3, y: 0.55, scale: 0.6 },
      { type: 'torch', x: 0.7, y: 0.55, scale: 0.6 },
      { type: 'window_glow', x: 0.45, y: 0.42, scale: 0.4 },
      { type: 'window_glow', x: 0.55, y: 0.42, scale: 0.4 },
      { type: 'mountain', x: 0.2, y: 0.75, scale: 0.4 },
      { type: 'mountain', x: 0.8, y: 0.75, scale: 0.5 },
    ],
  ...
  beach: {
    ...
    elements: [
      { type: 'water', x: 0.5, y: 0.7, scale: 1.5 },
      { type: 'tree', x: 0.15, y: 0.6, scale: 0.8 },
      { type: 'tree', x: 0.08, y: 0.65, scale: 0.6 },
      { type: 'mountain', x: 0.7, y: 0.65, scale: 0.7 },
      { type: 'mountain', x: 0.85, y: 0.7, scale: 0.5 },
    ],
  ...
  stars: {
    ...
    elements: [
      { type: 'mountain', x: 0.3, y: 0.8, scale: 0.5 },
      { type: 'mountain', x: 0.7, y: 0.75, scale: 0.6 },
      { type: 'water', x: 0.5, y: 0.92, scale: 0.8 },
    ],
  ...
  cave: {
    ...
    elements: [
      { type: 'cave_arch', x: 0.5, y: 0.4, scale: 1.2 },
      { type: 'torch', x: 0.25, y: 0.55, scale: 0.5 },
      { type: 'torch', x: 0.75, y: 0.55, scale: 0.5 },
      { type: 'rock', x: 0.3, y: 0.78, scale: 0.4 },
      { type: 'rock', x: 0.65, y: 0.8, scale: 0.5 },
      { type: 'water', x: 0.5, y: 0.92, scale: 0.6 },
    ],
  ...
  lake: {
    ...
    elements: [
      { type: 'water', x: 0.5, y: 0.55, scale: 2.0 },
      { type: 'tree', x: 0.1, y: 0.6, scale: 0.9 },
      { type: 'tree', x: 0.9, y: 0.58, scale: 1.0 },
      { type: 'mountain', x: 0.5, y: 0.65, scale: 0.8 },
      { type: 'window_glow', x: 0.1, y: 0.52, scale: 0.2 },
    ],
    defaultEffects: ['fireflies'],
    particles: {
      rate: 3,
  ...
  rain: {
    ...
    elements: [
      { type: 'water', x: 0.5, y: 0.95, scale: 0.5 },
      { type: 'tree', x: 0.2, y: 0.6, scale: 0.7 },
      { type: 'tree', x: 0.8, y: 0.55, scale: 0.8 },
      { type: 'building', x: 0.5, y: 0.65, scale: 0.5 },
    ],
    defaultEffects: ['rain'],
    particles: {
      rate: 80,
  ...
  snow: {
    ...
    elements: [
      ...
      { type: 'tree', x: 0.4, y: 0.55, scale: 1.0, variant: 1 },
      { type: 'tree', x: 0.7, y: 0.6, scale: 0.7, variant: 1 },
      { type: 'tree', x: 0.88, y: 0.56, scale: 0.9, variant: 1 },
      { type: 'mountain', x: 0.5, y: 0.8, scale: 0.5 },
      { type: 'building', x: 0.5, y: 0.7, scale: 0.4 },
    ],
  ...
  sunset: {
    ...
    elements: [
      { type: 'mountain', x: 0.3, y: 0.7, scale: 0.7 },
      { type: 'mountain', x: 0.7, y: 0.65, scale: 0.8 },
      { type: 'water', x: 0.5, y: 0.85, scale: 1.2 },
      { type: 'tree', x: 0.1, y: 0.6, scale: 0.6 },
      { type: 'tree', x: 0.9, y: 0.58, scale: 0.7 },
    ],
    defaultEffects: ['fireflies'],
    particles: {
      rate: 2,
  ...
  tavern: {
    ...
    elements: [
      { type: 'building', x: 0.5, y: 0.55, scale: 0.9 },
      { type: 'window_glow', x: 0.38, y: 0.42, scale: 0.3, color: '#ffaa44' },
      { type: 'window_glow', x: 0.62, y: 0.42, scale: 0.3, color: '#ffaa44' },
      { type: 'window_glow', x: 0.5, y: 0.48, scale: 0.35, color: '#ffcc66' },
      { type: 'torch', x: 0.2, y: 0.6, scale: 0.5 },
      { type: 'torch', x: 0.8, y: 0.6, scale: 0.5 },
