 ...
 * 按 priority 升序排列组件。
 */
export function WallpaperWidgetHost({ zone, ctx, className, style, renderEmpty = false }: WallpaperWidgetHostProps) {
  const visibleWidgets = useMemo(() => wallpaperWidgetRegistry.getVisibleWidgets(zone, ctx), [zone, ctx])
