...
import { buildSystemPrompt, estimateTokens, estimateMessageTokens, ConversationContext, trimOrphanedToolCallsFrom, } from '../context';
// ─── buildSystemPrompt ───
...
describe('estimateMessageTokens', () => {
    ...
    it('含 tool_call_id 时累加', () => {
        const m = { role: 'tool', content: 'result', tool_call_id: 'call_1' };
...
describe('ConversationContext', () => {
    ...
    it('addAssistant 追加含 tool_calls 的 assistant 消息', () => {
        ...
        expect(ctx.context[1].tool_calls).toHaveLength(1);
    });
