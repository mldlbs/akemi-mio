...
import { notificationQueue } from '../tool/definitions/TtsNotifyTool'
import type { NotifyPriority } from '../tool/definitions/TtsNotifyTool'
import {
...
export class EventMonitorService {
  ...
  private startPolling(id: string): void {
    ...
    }, Math.max(5000, config.pollIntervalMs)) // 最小 5 秒
