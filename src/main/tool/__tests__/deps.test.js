...
import { setPlanManager, getPlanManager, setCredentialsManager, getCredentialsManager, setMemoryService, getMemoryService, setSkillManager, getSkillManager, setProceduralMemory, getProceduralMemory, } from '../deps';
describe('tool deps', () => {
