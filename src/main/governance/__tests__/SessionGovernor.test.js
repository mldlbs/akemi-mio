...
import { getHealthLevel, RECOVERY_ACTIONS } from '../SessionGovernorTypes';
// =============================================================================
// SessionHealthScorer
// =============================================================================
describe('SessionHealthScorer', () => {
    ...
    it('guardrail trips affect score', () => {
        for (let i = 0; i < 10; i++)
            scorer.recordGuardrailTrip();
        const clean = new SessionHealthScorer();
        for (let i = 0; i < 10; i++)
            scorer.recordToolResult(true);
        for (let i = 0; i < 10; i++)
            clean.recordToolResult(true);
...
describe('RECOVERY_ACTIONS', () => {
    it('has all 8 levels', () => {
        for (let i = 1; i <= 8; i++) {
            expect(RECOVERY_ACTIONS[i]).toBeDefined();
        }
    });
});
// =============================================================================
...
describe('CheckpointV2', () => {
    it('verifyCheckpointHealth passes when healthy', () => {
        ...
        const cp = new CheckpointV2('/tmp/cp_test', {});
