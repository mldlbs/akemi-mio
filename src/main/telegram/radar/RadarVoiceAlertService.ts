...
import type { StartupSignal } from '../../startup-radar/types'
...
export class RadarVoiceAlertService {
  ...
  buildVoiceText(rule: RadarPushRule, signals: StartupSignal[], metrics: UrgencyMetrics): string {
    ...
    return fullText.length > MAX_VOICE_TEXT_LENGTH
      ? fullText.slice(0, MAX_VOICE_TEXT_LENGTH - 1) + '。'
      : fullText
  }
