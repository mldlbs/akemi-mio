...
const CAPABILITY_ENTRY_KEYS: ReadonlyArray<string> = [
  'capability',
  'failedCount',
  'totalCount',
  'affectedCaseIds',
...
const REGRESSION_ENTRY_KEYS: ReadonlyArray<string> = [
  'caseId',
  'category',
  'diffSummary',
  'fieldDiff',
...
const EVIDENCE_ENTRY_KEYS: ReadonlyArray<string> = [
  'caseId',
  'category',
  'inputText',
  'expected',
...
const TREND_ENTRY_KEYS: ReadonlyArray<string> = [
  'executedAt',
  'runnerVersion',
  'passRate',
  'total',
