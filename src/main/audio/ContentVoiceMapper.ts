...
const TUTORIAL_KEYWORDS: KeywordRule[] = [
  { keywords: ['教程', '指南', '入门', '上手', '安装', '配置', '使用', '方法', '步骤', '如何'], model: 'zh_CN-huayan-medium', reason: '教程内容 - 花颜·女声' },
  { keywords: ['API', 'SDK', '接口', '函数', '方法', '参数', '返回值', '类型', '代码'], model: 'zh_CN-huayan-medium', reason: '技术内容 - 花颜·女声' },
  { keywords: ['实现', '架构', '设计', '模式', '原理', '机制', '流程', '算法'], model: 'zh_CN-huayan-medium', reason: '架构内容 - 花颜·女声' },
]
