...
import type { Checkpoint, CheckpointableComponent, VersionedState, ComponentDescriptor, RestoreResult } from '../CheckpointTypes'
...
describe('CheckpointRestoreCoordinator — Scene 4: create failure', () => {
  it('should return failed when descriptor.create() throws', async () => {
    ...
    registry.register({
      id: 'workflow-runtime', version: '1.0',
      create: () => { throw new Error('factory error') },
    })
