...
import { OutcomeStore, type OutcomeRecord } from '../OutcomeStore'
import { GuardrailRecommendationStore, GuardrailFeedbackAnalyzer, type GuardrailRecommendation } from '../GuardrailFeedbackAnalyzer'
...
describe('T-6: config lifecycle isolation', () => {
  ...
  it('GuardrailConfigStore CONFIG_EVENT_TYPES does not include outcome', async () => {
    const { CONFIG_EVENT_TYPES } = await import('../EvaluationEventSchema')
