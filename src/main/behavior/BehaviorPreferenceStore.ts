...
import type { UserProfileData } from '../memory/MemoryService'
...
export class BehaviorPreferenceStore {
   ...
   */
  setBatch(entries: Array<{ key: string; value: PreferenceValue; category: PreferenceStat['category']; confidence?: number; metadata?: string }>): void {
  ...
  getFormattedContext(): string {
    ...
    // 纠正模式统计（仅注入有意义的模式）
    const meaningfulCorrections = Object.entries(snapshot.correctionStats)
